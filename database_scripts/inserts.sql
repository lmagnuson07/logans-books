...
insert into book (title, tagline, synopsis, number_of_pages, language, format, cover_image_url, qty_in_stock, qty_on_order, current_price, is_available) values ('Dragon Ball Z: Dead Zone (Doragon bôru Z 1: Ora no Gohan wo kaese)', 'Intuitive systematic initiative', 'Sed ante. Vivamus tortor. Duis mattis egestas metus.', 1096, 'Northern Sotho', 'Hardcover', 'https://covers.openlibrary.org/b/id/0000214056-L.jpg', 27, 39, 104.8344, 1);
...
insert into book (title, tagline, synopsis, number_of_pages, language, format, cover_image_url, qty_in_stock, qty_on_order, current_price, is_available) values ('Chill Out! (Descongélate!)', 'Extended optimal service-desk', 'Cras non velit nec nisi vulputate nonummy. Maecenas tincidunt lacus at velit. Vivamus vel nulla eget eros elementum pellentesque. Quisque porta volutpat erat. Quisque erat eros, viverra eget, congue eget, semper rutrum, nulla. Nunc purus. Phasellus in felis. Donec semper sapien a libero. Nam dui.', 1380, 'Marathi', 'Softcover', 'https://covers.openlibrary.org/b/id/0000356446-L.jpg', 30, 14, 126.8294, 1);
insert into book (title, tagline, synopsis, number_of_pages, language, format, cover_image_url, qty_in_stock, qty_on_order, current_price, is_available) values ('Gloomy Sunday (Ein Lied von Liebe und Tod)', 'Vision-oriented empowering paradigm', 'Aliquam quis turpis eget elit sodales scelerisque. Mauris sit amet eros. Suspendisse accumsan tortor quis turpis.', 569, 'Tetum', 'Softcover', 'https://covers.openlibrary.org/b/id/0000100587-L.jpg', 28, 19, 131.7472, 1);
insert into book (title, tagline, synopsis, number_of_pages, language, format, cover_image_url, qty_in_stock, qty_on_order, current_price, is_available) values ('Love Bites', 'Virtual heuristic forecast', 'Nullam porttitor lacus at turpis. Donec posuere metus vitae ipsum. Aliquam non mauris.', 1447, 'New Zealand Sign Language', 'Hardcover', 'https://covers.openlibrary.org/b/id/0000407756-L.jpg', 35, 13, 134.8445, 1);
...
insert into book (title, tagline, synopsis, number_of_pages, language, format, cover_image_url, qty_in_stock, qty_on_order, current_price, is_available) values ('Rollerball', 'Down-sized 6th generation pricing structure', 'Quisque id justo sit amet sapien dignissim vestibulum. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Nulla dapibus dolor vel est. Donec odio justo, sollicitudin ut, suscipit a, feugiat et, eros.', 1222, 'New Zealand Sign Language', 'Softcover', 'https://covers.openlibrary.org/b/id/0000873521-L.jpg', 34, 41, 102.6741, 1);
